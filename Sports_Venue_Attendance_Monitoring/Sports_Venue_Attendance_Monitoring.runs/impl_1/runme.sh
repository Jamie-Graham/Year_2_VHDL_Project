...
HD_PWD='C:/University_C_Drive/Year_2_VHDL_Project/Year_2_VHDL_Project/Sports_Venue_Attendance_Monitoring/Sports_Venue_Attendance_Monitoring.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Attendance_monitor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Attendance_monitor.tcl -notrace
