...
HD_PWD='C:/University_C_Drive/Year_2_VHDL_Project/Year_2_VHDL_Project/Sports_Venue_Attendance_Monitoring/Sports_Venue_Attendance_Monitoring.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Attendance_monitor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Attendance_monitor.tcl
